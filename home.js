...
const canWeDeliver = (zipCode) => {if (deliveryAreaZipCodes.includes(zipCode) === true){
...
changeTitle = (i, inp, out) => deals[i].title.replace(inp, out)
console.log(changeTitle(0, '15% Off!', '10% Off!'))
...
changeDesc = (i, inp, out) => deals[i].desc.replace(inp, out)
console.log(changeDesc(1, 'March!', 'April!'))